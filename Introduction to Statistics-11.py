...
max_fahrenheit=max(fahrenheit_degrees)
min_fahrenheit=min(fahrenheit_degrees)

max_yearly=max(yearly_town_population)
min_yearly=min(yearly_town_population)
...
mean=test_scores_positive.mean()
