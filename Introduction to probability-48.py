...
count_orange=len(orange)
orange_probability=count_orange/total_countries
stripe=flags[flags['stripes']> 1 ]
count_stripe=len(stripe)
stripe_probability=count_stripe/total_countries
